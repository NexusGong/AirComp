...
const routes = [
  ...
  { path: '/equipment/clients', component: () => import('../views/ClientEquipmentPage.vue'), meta: { requiresAuth: true } },
  { path: '/equipment/suppliers', component: () => import('../views/SupplierEquipmentPage.vue'), meta: { requiresAuth: true } },
